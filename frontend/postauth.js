...
axios.post('https://sayori.xyz/api_j/identity/v1/oauth2/token?grant_type=client_credentials&redirect_uri=Anthony_Levine-AnthonyL-Auctio-plpgzby&scope=https://api.ebay.com/oauth/api_scope', 
    null, {
        headers:{
